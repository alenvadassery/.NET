...
namespace CSharpSampleTestCodeLibrary.SampleClasses.ExceptionHandling
{
    public abstract class ExceptionInvokerCellPhone
    {
        //CellPhone Propeties
        public string Brand { get; set; }
        public string Type { get; set; }

        public ExceptionInvokerCellPhone() { }
        public ExceptionInvokerCellPhone(string brand, string type)
        {
            this.Brand = brand;
            this.Type = type;
        }
    ...
    public class FeaturePhone : ExceptionInvokerCellPhone
    {
